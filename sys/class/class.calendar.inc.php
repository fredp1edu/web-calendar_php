...
<label for "event_type">Type:>Type:</label>
...
<label for "event_end">Type:>End Time:</label>
...
<label for "event_desc">Type:>Description:</label>
    <textarea name="event_desc" id="event_desc" value="$event->desc" />
<label for "event_start">Reminder:</label>
